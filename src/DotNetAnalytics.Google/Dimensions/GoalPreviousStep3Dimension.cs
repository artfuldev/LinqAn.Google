...
{
    /// <summary>
    ///     The page path or screen name that matched any destination type goal, three steps prior to the goal completion
    ///     location.
    /// </summary>
    public class GoalPreviousStep3Dimension : Dimension<string>
    {
        ...
        /// </summary>
        public GoalPreviousStep3Dimension()
            : base(

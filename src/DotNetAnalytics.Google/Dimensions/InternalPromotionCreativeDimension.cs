namespace DotNetAnalytics.Google.Dimensions
{
	...
	/// 	Instantiates a <seealso cref="InternalPromotionCreativeDimension" />.
		/// </summary>
		public InternalPromotionCreativeDimension(): base("Internal Promotion Creative","The creative content designed for a promotion (Enhanced Ecommerce).",true,"ga:internalPromotionCreative")
		{

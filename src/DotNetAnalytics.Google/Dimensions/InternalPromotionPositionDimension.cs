namespace DotNetAnalytics.Google.Dimensions
{
	...
	/// 	Instantiates a <seealso cref="InternalPromotionPositionDimension" />.
		/// </summary>
		public InternalPromotionPositionDimension(): base("Internal Promotion Position","The position of the promotion on the web page or application screen (Enhanced Ecommerce).",true,"ga:internalPromotionPosition")
		{

namespace LinqAn.Google.Dimensions
{
	...
	public class Affiliation: Dimension<string>
	{
		...
		/// </summary>
		public Affiliation(): base("Affiliation","Typically used to designate a supplying company or brick and mortar location; product affiliation.",true,"ga:affiliation")
		{

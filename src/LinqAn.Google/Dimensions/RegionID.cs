...
{
    /// <summary>
    ///     The region ID of users, derived from IP addresses or Geographical IDs. In the U.S., a region is a state, such as
    ///     New York. The region IDs are the same as the Criteria IDs found at:

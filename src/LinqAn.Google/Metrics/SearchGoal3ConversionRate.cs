...
namespace LinqAn.Google.Metrics
{
	...
	public class SearchGoal3ConversionRate: Metric<float>
	{
		/// <summary>
		/// 	Instantiates a <seealso cref="SearchGoal3ConversionRate" />.
		/// </summary>
		public SearchGoal3ConversionRate(): base("Site Search Goal 3 Conversion Rate",false,"ga:searchGoal3ConversionRate")
		{

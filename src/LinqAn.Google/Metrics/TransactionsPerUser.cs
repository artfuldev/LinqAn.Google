namespace LinqAn.Google.Metrics
{
	...
	/// 	Instantiates a <seealso cref="TransactionsPerUser" />.
		/// </summary>
		public TransactionsPerUser(): base("Transactions per User","The total number of transactions divided by the total number of users.",false,"ga:transactionsPerUser")
		{
